...
- Using the information below, or from the public dataset itself:
	- Create a query that will retrieve all mascots from Oxford Blue teams.
	- Create a query that will retrieve all players from Oxford Blue teams who scored more than 10 points in a game.
	- Find the number of players from who played for a team with a 'Mythical Creatures' mascot who also scored more than 10 points in a game.
